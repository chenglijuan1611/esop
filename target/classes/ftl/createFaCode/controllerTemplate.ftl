...
@RequestMapping(value="/save")
	public ModelAndView save(String checkadd) throws Exception{
...
<#list fieldList as var>
	...
	public ModelAndView edit(String checkadd) throws Exception{
		...
		//添加判断是否重复添加
		if(checkadd!=null&&checkadd.equals("checked")) {
