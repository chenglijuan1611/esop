...
function changeUser(){
	...
	console.log(path);
	/*$.removeCookie("userid",{ path: '/dafeng_mes/app/mobile_mes'});
	$.removeCookie("password",{ path: '/dafeng_mes/app/mobile_mes'});*/
	$.cookie('userid', null, {path:'/'});
	$.cookie('password', null, {path:'/'});
	$.ajax({		
		url:locationUrl + '/android/appLogout',
		type:'post',
		cache:false,
...
function loadList(pno,url,menuname,startTime,endTime,flag,likeName){
	...
	$(".firstShopMenu,.secondShopMenu,.thirdShopMenu,.fourthShopMenu").hide();					//隐藏面包屑导航
...
/*ERP/MES查询模块开始*/
	...
	var loadListUrl = locationUrl+"/"+url;	   //请求地址
	/*发送请求获取ERP/MES查询数据*/
	$.ajax({
		type:"post",
	    url:loadListUrl,	   
...
function getMenuList(){
	var url = locationUrl+"/android/getMenu";
...
function displayWorkshop(){															
	...
	$.ajax({
		...
		success: function(data){
			...
			var fourthWorkshopData = data.varList4;
			console.log(fourthWorkshopData);
			var firstShop = {};
			var secondShop = {};
			var thirdShop = {};
			var fourthShop = {};
			$.each(workShopData,function(index,item){
				if(item.TYPE == "1"){
					...
					fourthShop.planAmount = item.PLAN_AMOUNT;
					fourthShop.actualAmount = item.PRODUCT_AMOUNT;
					if(fourthShop.actualAmount == 0){
						fourthShop.actualAmount = "";
					}
					return fourthShop;
				}
			})		
		...
		                fontWeight: 'normal'
	            ...
	            dataset: {
	                ...
	                source: [
	                    ...
	                    {product: '四车间', '计划': fourthShop.planAmount, '实际': fourthShop.actualAmount}
	                ]
	            },
	            xAxis: {
	            	type: 'category',
...
/*							console.log("三车间数据");
							...
							$(".planList").show();
							//展示四车间计划
							}else if(params.value.product == "四车间"){
							$(".breadcrumb").append("<li class='fourthShopMenu'><strong>四车间生产计划</strong></li>");										
		/*						console.log("二车间数据");
								console.log(secondWorkshopData);
								console.log("二车间数据");*/
								var append4 = "";
								append4 = append4 + "<div class='legend'>";
								append4 = append4 + "<div class='leg plan'></div><span style='margin-left:3px;'>计划数量</span>";
								append4 = append4 + "<div class='leg theo'></div><span style='margin-left:3px;'>理论数量</span>";
								append4 = append4 + "<div class='leg actu'></div><span style='margin-left:3px;'>实际数量</span>";
								append4 = append4 + "</div>";
								$.each(secondWorkshopData,function(index,item){
									var fourthPlan = parseInt(item.PLAN_AMOUNT);
									var fourthActual = parseInt(item.PRODUCT_AMOUNT);
									var fourthTheory = parseInt(item.THEORY_AMOUNT);
									console.log(fourthTheory);
									var fourthPercent = "";
									var fourthEfficiency = "";
									var fourthWorkpiece = "";
									if(fourthActual != 0){
										fourthPercent = (fourthActual/fourthPlan);
										console.log(fourthPercent);
										fourthPercent = (fourthPercent*100).toFixed(0)+"%";
										console.log(fourthPercent);								
									}else{
										fourthPercent = "0%";
									}
									if(fourthTheory != 0){
										fourthEfficiency = (fourthActual/fourthTheory);
										fourthWorkpiece = (fourthTheory/fourthPlan);
										console.log(fourthEfficiency);
										fourthEfficiency = (fourthEfficiency*100).toFixed(0)+"%";
										fourthWorkpiece = (fourthWorkpiece*100).toFixed(0)+"%";
										console.log(fourthEfficiency);
									}else{
										fourthEfficiency = "0%";
									}
									append4 = append4 + "<div class='progessGroup'>";
									append4 = append4 + "<div class='planName'>";
									append4 = append4 +	"<span>"+item.PRODUCT_SPECIFICATIONS+"</span>";
									append4 = append4 + "</div>";
									append4 = append4 + "<div class='lineName'>";
									append4 = append4 +	"<span>"+item.NAME+"</span>";
									append4 = append4 + "</div>";
									append4 = append4 + "<div class='progress plan'>";
									append4 = append4 +	"<div class='progress-bar progress-bar-danger' role='progressbar' aria-valuenow='60' aria-valuemin='0' aria-valuemax='100' style='width: 100%;'>"+item.PLAN_AMOUNT+"</div>";
									append4 = append4 + "</div>";
									append4 = append4 + "<div class='progress theory'>";
									append4 = append4 +	"<div class='progress-bar progress-bar-warning' role='progressbar' aria-valuenow='60' aria-valuemin='0' aria-valuemax='100' style='width:"+fourthWorkpiece+"'>"+item.THEORY_AMOUNT+"</div>";
									append4 = append4 + "</div>";
									append4 = append4 + "<div class='progress actual'>";
									append4 = append4 + "<div class='progress-bar progress-bar-success' role='progressbar' aria-valuenow='60' aria-valuemin='0' aria-valuemax='100' style='width:"+fourthPercent+"'>"+item.PRODUCT_AMOUNT+"</div>";							
									append4 = append4 + "</div>";
									append4 = append4 + "<div class='row'>";
									append4 = append4 + "<div class='col-xs-6'><span><strong>生产效率</strong>&nbsp;&nbsp;</span><span class='proInefficiency'>"+fourthEfficiency+"</span></div>";	
									append4 = append4 + "<div class='col-xs-6'><span><strong>生产进度</strong>&nbsp;&nbsp;</span><span class='proProcess'>"+fourthPercent+"</span></div>";
									append4 = append4 + "</div>";
									append4 = append4 + "</div>";
								});
								$(".planList").append(append4);	
								$(".echarts_workshopBrowse").hide();
								$(".echarts_outAmountAnalyse").hide();
								$(".echarts_outValueAnalyse").hide();
								$(".planList").show();	
...
function jumpToWorkshop(){														
	...
	$(".echarts_workshopBrowse").show();
	$(".planMenu").hide();
	$(".firstShopMenu,.secondShopMenu,.thirdShopMenu,.fourthShopMenu").hide();
...
function getPlanCompeleteCharts(){
	...
	$.ajax({
		url:locationUrl+'/mes/complete.do',
		type:'post',
		cache:false,
		dataType:'json',
		success: function(data){
...
function outputValueAnalyse(){
	...
	$.ajax({
		url:locationUrl+'/mes/outputValue',
		type:'post',
		cache:false,
		dataType:'json',
		success: function(data){
