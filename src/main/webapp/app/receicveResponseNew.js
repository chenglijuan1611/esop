        	...
        	if(DataNew[0] == "[私信]  1"){
        		...
        		if(DataNew[1].indexOf("&") == -1){      		
        			...
        			for(var i = 0;i<theseUrl.length;i++){       				
        				...
        				append1 = append1 +	"<div class='swiper-slide'><div class='' style='width:100%;height:"+height+"px;margin-left:11%;background:url("+theseUrl[i]+") no-repeat;background-size:contain'>";					       
        				append1 = append1 + "</div>";
        				append1 = append1 + "</div>";        				        				
	    		 	}
        			append1 = append1 + "</div>";
    		  ...
    		  if(firstImgURL.indexOf("&") == -1){
    			  ...
    			  if(firstImgURL == "http://172.16.20.182:8080/processFile/default.png"){
    			    ...
    			    $(".swiper-container").remove();    			   
    		 		...
    		 		append3 = append3 +	"<div class='swiper-slide'><div class='' style='width:100%;height:"+height+"px;margin-left:11%;background:url("+firstImgList[j]+") no-repeat;background-size:contain'>";					       
    		 		append3 = append3 + "</div>";
    		 		append3 = append3 + "</div>";    		 		   		 		
    		 	}
    		  		append3 = append3 + "</div>";
