				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							...
							<!-- 检索  -->
							<form action="attached/list.do" method="post" name="Form"
								id="Form">
																...
																<div class="hidden-sm hidden-xs btn-group">
																	<c:if test="${QX.edit == 1 }">
																		...
																		<a class="btn btn-xs btn-success" title="编辑"
																			onclick="edit('${var.ATTACHED_ID}');"> <i
