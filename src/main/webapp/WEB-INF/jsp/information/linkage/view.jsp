							...
							<table>
								<tr>
									<td><select name="level1" id="level1"
										onchange="change1(this.value)">
											<option>请选择</option>
									</select></td>
									<td style="padding-left: 2px"><select id="level2"
										name="level2" onchange="change2(this.value)">
											<option>请选择</option>
									</select></td>
									<td style="padding-left: 2px"><select id="level3"
										name="level3" onchange="change3(this.value)">
											<option>请选择</option>
									</select></td>
									<td style="padding-left: 2px"><select id="level4"
										name="level4">
											<option>请选择</option>
									</select></td>
								</tr>
