	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			<div class="main-content-inner">
				<!-- 检索  -->
				<form action="pictures/listfortc.do" method="post" name="Form"
					id="Form">
									...
									<c:if test="${QX.cha == 1 }">
										<c:forEach items="${varList}" var="var" varStatus="vs">
											<tr>
												...
												<td class="center"><a
													href="<%=basePath%>uploadFiles/uploadImgs/${var.PATH}"
													title="${var.TITLE}" class="bwGal"><img
														src="<%=basePath%>uploadFiles/uploadImgs/${var.PATH}"
														alt="${var.TITLE}" width="100"></a></td>
												<td class="center">${var.TITLE}</td>
												<td class="center" style="width: 130px;"><a
													class="btn btn-xs btn-info" title="选择"
													onclick="xuanTp('<%=basePath%>uploadFiles/uploadImgs/${var.PATH}');">选择
												</a></td>
											</tr>
