						...
						<div class="col-xs-12">
							...
							<div class="well well-sm">
								<h4 class="lighter no-margin-bottom">
									...
									<span class="input-icon"> <input type="text"
										id="serverUrl" title="请输入要爬的网页地址" placeholder="请输入要爬的网页地址"
										style="width: 540px;"> <i class="ace-icon fa fa-globe"></i>
									</span> <a class="btn btn-xs btn-info" title='爬取'
										onclick="getUrl('');"> <i
										class="ace-icon fa fa-cloud-download bigger-120" title="爬取"></i>
									</a> &nbsp; <a class="btn btn-xs btn-info" title='请求'
										onclick="getUrl('save');" id="savebut"> 保存至服务器 </a>
								</h4>
							</div>
							...
							<div>
								<ul class="ace-thumbnails clearfix" id="imgList">
									...
									<li style="display: none;"><a href="" data-rel="colorbox">
