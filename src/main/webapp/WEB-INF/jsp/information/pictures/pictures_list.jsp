										...
										<c:forEach items="${varList}" var="var" varStatus="vs">
											<tr>
												<td class='center' style="width: 30px;"><label><input
														...
														value="${var.PICTURES_ID}" /><span class="lbl"></span></label></td>
												...
												<td class="center" style="width: 130px;"><c:if
														...
														<a style="cursor: pointer;" class="green"
															onclick="edit('${var.PICTURES_ID}');" title="编辑"> <i
						...
						<table style="width: 100%;">
							<tr>
								<td style="vertical-align: top;"><c:if
										...
										<a title="批量删除" class="btn btn-sm btn-danger"
