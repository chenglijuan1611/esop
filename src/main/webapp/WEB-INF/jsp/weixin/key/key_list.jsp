														...
														<tr>
															...
															<td class="center"><c:if
																...
																<div class="hidden-sm hidden-xs btn-group">
																	<a class="btn btn-xs btn-purple" title="自定义菜单"
																		onclick="weixinMenu('${var.WXUSERNAME}');"> 自定义菜单
																	</a>
																	<c:if test="${QX.edit == 1 }">
																		<a class="btn btn-xs btn-success" title="编辑"
																			onclick="edit('${var.KEY_ID}');"> <i
