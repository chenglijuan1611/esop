...
ul, li, p, form, h1, h2, h3, h4, h5, dl, dt, dd {
	margin: 0;
	padding: 0;
	list-style: none
}
...
<body>
	...
	<table>
			...
			<td>
				<div class="wx-main">
					...
					<div class="wx-left">
						...
						<div class="l-fot">
							<div class="l-fot-first">
								<img src="static/weixin/keyboard.png" width="60%" alt=""
									id="tsMsg" />
							</div>
							<ul>
								<li id="one-a">无</li>
						...
						<div class="add-lw">
							...
							<div class="dis"
								style="width: 89px; height: 0px; line-height: 45px; border: 1px solid #cdcdcd; position: absolute; bottom: 110px; left: 47px; font-size: 16px; text-align: center; font-weight: bold; color: #353637; background-color: #f5f5f9;"
								id="table-l"></div>
						</div>
						<div class="add-mw">
							...
							<div class="dis"
								style="width: 89px; height: 0px; line-height: 45px; border: 1px solid #cdcdcd; position: absolute; bottom: 110px; left: 135px; font-size: 16px; text-align: center; font-weight: bold; color: #353637; background-color: #f5f5f9;"
								id="table-m"></div>
						</div>
						<div class="add-rw">
							...
							<div class="dis"
								style="width: 89px; height: 0px; line-height: 45px; border: 1px solid #cdcdcd; position: absolute; bottom: 110px; left: 224px; font-size: 16px; text-align: center; font-weight: bold; color: #353637; background-color: #f5f5f9;"
								id="table-r"></div>
						</div>
					</div>
					<!--右部分-->
					<div class="wx-right">
						<div class="r-top">
							<p>
								<span class="r-topl" id="mtitle">一级菜单</span><span class="r-topr"
									onclick="deleteM();">删除菜单</span>
							</p>
							<div class="clr"></div>
						</div>
						<div class="r-name" style="display: none;" id="titlexx">
							<form action="" method="">
								<label>菜单名称</label> <input type="input" placeholder="输入菜单名称"
									id="menuname" onkeyup="setTitle(this.value)"> <input
									type="hidden" value="click" id="mtype">
							</form>
							<P>字数不超过4个汉字或8个字母</P>
						</div>
						<div class="r-cont" id="otherxx" style="display: none;">
							<form action="" method="">
								...
								<label>发送消息&nbsp;&nbsp;&nbsp;&nbsp;</label> <input id="mes-l"
									type="radio" name="mes"> <label>跳转网页</label>
							</form>
							<div id="mes-fx" class="messe">
								<p>发送消息</p>
								<textarea placeholder="请输入消息" id="content1"
									onkeyup="setContent(this.value);"></textarea>
							</div>
							<div id="mes-lx" class="messe dis">
								<p>发送链接</p>
								<textarea placeholder="请输入链接" id="content2"
									onkeyup="setContent(this.value);"></textarea>
							</div>
						</div>
						<div class="r-bottom">
							<div class="clr"></div>
							<p>
								<span class="r-topl"></span><span class="r-topr"
									onclick="createM();">生成菜单</span>
							</p>
						</div>
					</div>
				</div>
				<form action="<%=basePath%>mymenu/setMyMenu.do" id="form"
					method="post">
					<input name="WXUSERNAME" id="WXUSERNAME" value="${pd.WXUSERNAME }"
						type="hidden" />
					<c:forEach items="${varList}" var="var" varStatus="vs">
						<input name="${var.XID }" id="${var.XID }"
							value="${var.TITLE},fh,${var.TYPE},fh,${var.CONTENT}"
							type="hidden">
					</c:forEach>
				</form>
			</td>
		...
		<tr>
			<td>错误代码说明：<a
				href="https://wenku.baidu.com/view/5edee974f78a6529647d53a1.html"
				target="_bank">https://wenku.baidu.com/view/5edee974f78a6529647d53a1.html</a>(返回错误代码说明功能正常，只是参数配置问题，具体根据错误代码看说明)
			</td>
		</tr>
	</table>
</body>
