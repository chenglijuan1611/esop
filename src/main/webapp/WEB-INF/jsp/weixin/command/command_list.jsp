				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							...
							<!-- 检索  -->
							<form action="command/list.do" method="post" name="Form"
								id="Form">
													...
													<c:forEach items="${varList}" var="var" varStatus="vs">
														<tr>
															<td class='center' style="width: 30px;"><label><input
																	...
																	value="${var.COMMAND_ID}" /><span class="lbl"></span></label>
															</td>
																...
																<div class='hidden-phone visible-desktop btn-group'>
																	...
																	<c:if test="${QX.edit == 1 }">
																		<a style="cursor: pointer;" class="green"
																			onclick="edit('${var.COMMAND_ID}');" title="编辑">
																			<i class="ace-icon fa fa-pencil bigger-130"></i>
																		</a>
																	</c:if>
																	<c:if test="${QX.del == 1 }">
																		<a style="cursor: pointer;" class="red"
																			onclick="del('${var.COMMAND_ID}');" title="删除"> <i
