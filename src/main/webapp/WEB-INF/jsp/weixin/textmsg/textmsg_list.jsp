				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							...
							<!-- 检索  -->
							<form action="textmsg/list.do" method="post" name="Form"
								id="Form">
										...
										<td>
											<div class="nav-search">
												<span class="input-icon"> <input
													...
													value="${pd.KEYWORD }" placeholder="这里输入关键词" /> <i
													id="nav-search-icon"
									...
									<thead>
										<tr>
											<th class="center" style="width: 30px;"><label><input
													type="checkbox" id="zcheckbox" class="ace" /><span
													...
													<c:forEach items="${varList}" var="var" varStatus="vs">
														<tr>
															<td class='center' style="width: 30px;"><label><input
																	...
																	value="${var.TEXTMSG_ID}" /><span class="lbl"></span></label>
															</td>
															...
															<td style="width: 100px;" class="center"><c:if
																	...
																	<a style="cursor: pointer;" class="green"
																		onclick="edit('${var.TEXTMSG_ID}');" title="编辑"> <i
																		class="ace-icon fa fa-pencil bigger-130"></i>
																	</a>
																</c:if> <c:if test="${QX.del == 1 }">
																	<a style="cursor: pointer;" class="red"
																		onclick="del('${var.TEXTMSG_ID}');" title="删除"> <i
