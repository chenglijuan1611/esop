										...
										<div class="step-content row-fluid position-relative">
											<div class="widget-box" style="width: 50%;">
												<div
													...
													<h5>
														<i class="icon-credit-card"></i> 回复类型
													</h5>
													<div class="widget-toolbar no-border"></div>
												</div>
												<div class="widget-body">
													<div class="widget-main">${msg}</div>
													<!--/widget-main-->
												</div>
												<!--/widget-body-->
											</div>
											...
											<div class="widget-box" style="width: 50%;">
												<div
													class="widget-header widget-header-flat widget-header-small">
													<h5>
														<i class="icon-credit-card"></i> 回复内容
													</h5>
													<div class="widget-toolbar no-border"></div>
												</div>
												<div class="widget-body">
											...
											<div class="step-content row-fluid position-relative">
												<ul class="unstyled spaced2">
													<li class="text-warning green"><i
														class="icon-star blue"></i> 在文本回复、图文回复、应用命令中</li>
													<li class="text-warning green"><i
														class="icon-star blue"></i> 添加一个关键词为"关注"的记录</li>
													<li class="text-warning green"><i
														class="icon-star blue"></i> 即为关注回复内容</li>
												</ul>
											</div>
