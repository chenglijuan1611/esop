								...
								<table style="margin-top: 5px;">
									<tr>
										...
										<td style="vertical-align: top; padding-left: 2px;"><select
											class="chosen-select form-control" name="TYPE" id="id"
													...
													<c:forEach items="${varList}" var="var" varStatus="vs">
														<tr>
															<td class='center'><label class="pos-rel"><input
																	type='checkbox' name='ids' value="${var.FHDB_ID}"
															...
															<c:if test="${remoteDB == 'no' }">
																<td class='center'>${var.DBSIZE}&nbsp;KB</td>
															</c:if>
															...
															<td class="center"><c:if
																...
																<div class="hidden-sm hidden-xs btn-group">
																	<c:if test="${QX.edit == 1 }">
																		<a class="btn btn-xs btn-success" title="还原"
																			onclick="dbRecover('${var.TABLENAME}','${var.SQLPATH}');">
																			还原 </a>
																	</c:if>
																	<c:if test="${QX.edit == 1 }">
																		<a class="btn btn-xs btn-info" title="编辑"
																			onclick="edit('${var.FHDB_ID}');"> <i
																		...
																		<ul
																			...
																			<c:if test="${QX.edit == 1 }">
																				<li><a style="cursor: pointer;"
																					...
																					title="还原"> <span class="green"> 还原 </span>
																				</a></li>
																			</c:if>
																			<c:if test="${QX.edit == 1 }">
																				<li><a style="cursor: pointer;"
																					onclick="edit('${var.FHDB_ID}');"
																					class="tooltip-info" data-rel="tooltip" title="修改">
																						<span class="green"> <i
										...
										<tr>
											<td style="vertical-align: top;"><c:if
													...
													<a class="btn btn-sm btn-danger"
														onclick="makeAll('确定要删除选中的记录吗？(确保数据安全性,只删除记录,不删除物理硬盘数据)','1');"
														title="批量删除"><i
											...
											<td>
												<div id="backuping2" style="padding-top: 8px; display: none">
													<h4 class="lighter block red">正在还原……</h4>
												</div>
											</td>
