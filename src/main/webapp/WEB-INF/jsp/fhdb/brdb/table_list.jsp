					...
					<div class="row">
						<div class="col-xs-12">
							...
							<table style="margin-top: 10px;">
								<tr>
									<td><span
										class="label label-lg label-success arrowed-right">${dbtype}</span>

										<span
										class="label label-lg label-yellow arrowed-in arrowed-in-right"
										id="backupts">${databaseName}</span></td>
									<td>
										<div id="backuping1" class="center" style="display: none">
											<img src="static/images/jzx.gif" width="50" />
										</div>
									</td>
									<td>
										<div id="backuping2" style="padding-top: 8px; display: none">
											<h4 class="lighter block red">正在备份……</h4>
										</div>
									</td>
								</tr>
							</table>
													...
													<tr>
														<c:if test="${dbtype != 'sqlserver' }">
															<td class='center'><label class="pos-rel"><input
																	type='checkbox' name='ids' id='fhid${vs.index}'
																	value="${var}" class="ace" /><span class="lbl"></span></label>
															</td>
														</c:if>
														...
														<c:if test="${dbtype != 'sqlserver' }">
															<td class="center" style="width: 100px;"><c:if
																...
																<div class="hidden-sm hidden-xs btn-group">
																	<c:if test="${QX.add == 1 }">
																		<a class="btn btn-xs btn-success" title="备份"
																			onclick="backupTable('${var}');"> 备份 </a>
																	</c:if>
																</div>
																		...
																		<ul
																			...
																			<c:if test="${QX.add == 1 }">
																				<li><a style="cursor: pointer;"
																					onclick="backupTable('${var}');"
																					class="tooltip-success" data-rel="tooltip"
																					title="备份"> <span class="green"> <i
																							class="ace-icon glyphicon glyphicon-play"></i>
																					</span>
																				</a></li>
																			</c:if>
																		</ul>
										...
										<td style="vertical-align: top;"><c:if
												...
												<c:if test="${dbtype != 'sqlserver' }">
													<a class="btn btn-sm btn-success"
														onclick="makeAll('确定要批量备份这些表吗？');">备份表</a>
												</c:if>
												<a class="btn btn-sm btn-info" onclick="backupall();">备份整个库</a>
											</c:if></td>
										<td style="vertical-align: top;"><div class="pagination"
												style="float: right; padding-top: 0px; margin-top: 0px;"></div></td>
									</tr>
								</table>
							</div>
