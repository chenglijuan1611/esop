				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="timingbackup/${msg }.do" name="Form" id="Form"
								method="post">
								<input type="hidden" name="TIMINGBACKUP_ID" id="TIMINGBACKUP_ID"
									value="${pd.TIMINGBACKUP_ID}" />
								<div id="zhongxin" style="padding-top: 13px;">
									<table id="table_report"
										class="table table-striped table-bordered table-hover">
										<tr>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">备份对象:</td>
											<td style="vertical-align: top; padding-left: 2px;"><select
												class="chosen-select form-control" name="TABLENAME"
												id="TABLENAME" data-placeholder="请选择"
												style="vertical-align: top; width: 200px;">
													...
													<c:if test="${dbtype != 'sqlserver' }">
														<c:forEach items="${varList}" var="varTab">
															<option value="${varTab }"
																<c:if test="${pd.TABLENAME==varTab}">selected</c:if>>${varTab }</option>
														</c:forEach>
													</c:if>
											</select></td>
										</tr>
										<tr>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">时间规则:</td>
											<td><input type="text" name="FHTIME" id="FHTIME"
												value="${pd.FHTIME}" maxlength="30" placeholder="这里输入时间规则"
												title="时间规则" style="width: 98%;" /></td>
										</tr>
										<tr>
											<td
									...
									<table id="table_report"
										...
										<tr>
											<td colspan="10"><input type="text" class="center"
												name="TIMEEXPLAIN" id="TIMEEXPLAIN"
												value="${pd.TIMEEXPLAIN}" maxlength="100"
												placeholder="这里是规则说明" title="规则说明" style="width: 100%;"
