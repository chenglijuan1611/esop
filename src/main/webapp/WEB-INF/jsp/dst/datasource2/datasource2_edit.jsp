				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="datasource2/${msg }.do" name="Form" id="Form"
								method="post">
								<input type="hidden" name="DATASOURCE2_ID" id="DATASOURCE2_ID"
									value="${pd.DATASOURCE2_ID}" />
									...
									<table id="table_report"
										...
										<tr>
											...
											<td><input type="text" name="CONTENT" id="CONTENT"
												value="${pd.CONTENT}" maxlength="255" placeholder="这里输入内容"
												title="内容" style="width: 98%;" /></td>
										</tr>
										<tr>
