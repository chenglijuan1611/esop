				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							...
							<!-- 检索  -->
							<form action="datasource2/list.do" method="post" name="Form"
								id="Form">
													...
													<c:forEach items="${varList}" var="var" varStatus="vs">
														<tr>
															<td class='center'><label class="pos-rel"><input
																	...
																	value="${var.DATASOURCE2_ID}" class="ace" /><span
																...
																<div class="hidden-sm hidden-xs btn-group">
																	<c:if test="${QX.edit == 1 }">
																		<a class="btn btn-xs btn-success" title="编辑"
																			onclick="edit('${var.DATASOURCE2_ID}');"> <i
																	...
																	<c:if test="${QX.del == 1 }">
																		<a class="btn btn-xs btn-danger"
																			onclick="del('${var.DATASOURCE2_ID}');"> <i
																		...
																		<ul
																			...
																			<c:if test="${QX.edit == 1 }">
																				<li><a style="cursor: pointer;"
																					onclick="edit('${var.DATASOURCE2_ID}');"
																			...
																			<c:if test="${QX.del == 1 }">
																				<li><a style="cursor: pointer;"
																					onclick="del('${var.DATASOURCE2_ID}');"
