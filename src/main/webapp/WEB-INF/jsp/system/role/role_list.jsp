						...
						<div class="col-xs-12">
										...
										<c:when test="${not empty roleList}">
											<c:forEach items="${roleList}" var="role" varStatus="vs">
												<td style="width: 100px;" class="center"
													...
													href="role.do?ROLE_ID=${role.ROLE_ID }"
								...
								<tr>
									...
									<td><c:if test="${QX.edit == 1 }">
											<a class="btn btn-mini btn-info"
												onclick="editRole('${pd.ROLE_ID }');">修改组名称<i
												...
												<tr>
													...
													<c:if test="${QX.edit == 1 }">
														<td style="width: 30px;"><a
															...
															class="btn btn-warning btn-mini" title="分配新增权限"><i
																class="ace-icon fa fa-wrench bigger-110 icon-only"></i></a></td>
														<td style="width: 30px;"><a
													...
													<td style="width: 155px;"><c:if
															...
															<a class='btn btn-mini btn-info' title="编辑"
																...
																class='ace-icon fa fa-pencil-square-o bigger-130'></i></a>
														</c:if> <c:choose>
															<c:when
																test="${var.ROLE_ID == '2' or var.ROLE_ID == '1'}">
															</c:when>
															<c:otherwise>
																<c:if test="${QX.del == 1 }">
																	<a class='btn btn-mini btn-danger' title="删除"
							...
							<div>
								...
								&nbsp;&nbsp;<a class="btn btn-sm btn-success"
										onclick="addRole('${pd.ROLE_ID }');">新增角色</a>
								</c:if>
							</div>
