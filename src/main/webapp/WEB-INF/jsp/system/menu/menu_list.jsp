										...
										<c:when test="${not empty menuList}">
											<c:forEach items="${menuList}" var="menu" varStatus="vs">
												<tr>
													...
													<td class='center'><i
														class="ace-icon fa ${menu.MENU_STATE == 1? 'fa-eye': 'fa-eye-slash'}"></i></td>
													<td class='center'><c:if
														...
														<div class="hidden-sm hidden-xs action-buttons">
															<c:if test="${QX.edit == 1 }">
																<a class="blue"
																	href="javascript:editTb('${menu.MENU_ID }');"> <i
																	class="ace-icon glyphicon glyphicon-picture bigger-130"
																	title="编辑图标"></i>
																</a>
																<a class="green"
																	href="javascript:editmenu('${menu.MENU_ID }');"> <i
															...
															<c:if test="${QX.del == 1 }">
																<a class="red"
																	href="javascript:delmenu('${menu.MENU_ID }');"> <i
														...
														<div class="hidden-md hidden-lg">
															<div class="inline pos-rel">
																...
																<ul
																	...
																	<c:if test="${QX.edit == 1 }">
																		<li><a
																			href="javascript:editTb('${menu.MENU_ID }');"
																		...
																		<li><a
																			href="javascript:editmenu('${menu.MENU_ID }');"
																	...
																	<c:if test="${QX.del == 1 }">
																		<li><a
																			href="javascript:delmenu('${menu.MENU_ID }');"
							...
							<div>
								...
								<c:if test="${QX.add == 1 }">
									<a class="btn btn-sm btn-success"
										onclick="addmenu('${MENU_ID}');">新增</a>
								</c:if>
								<c:if test="${null != pd.MENU_ID && pd.MENU_ID != '0'}">
									<a class="btn btn-sm btn-success"
										onclick="goSonmenu('${pd.PARENT_ID}');">返回</a>
								</c:if>
							</div>
