													...
													<table>
														<tr>
															...
															<td><input type="text" name="dbAddress"
																id="dbAddress" value="localhost" maxlength="200"
														...
														<tr>
															...
															<td><input type="text" name="username" id="username"
																value="root" maxlength="32" placeholder="输入用户名"
																title="用户名" /></td>
															<td>&nbsp;密码：</td>
															<td><input type="password" name="password"
																id="password" maxlength="32" placeholder="输入密码"
																title="密码" /></td>
															<td>&nbsp;库名：</td>
															<td><input type="text" name="databaseName"
																id="databaseName" maxlength="32" placeholder="输入数据库名"
																title="数据库名" /></td>
														</tr>
													</table>
												</div>
