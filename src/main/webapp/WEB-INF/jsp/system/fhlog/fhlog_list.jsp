...
<body class="no-skin">
													...
													<c:forEach items="${varList}" var="var" varStatus="vs">
														<tr>
															<td class='center'><label class="pos-rel"><input
																	type='checkbox' name='ids' value="${var.FHLOG_ID}"
	...
	<script type="text/javascript">
		...
		function toExcel(){
			...
			window.location.href='<%=basePath%>fhlog/excel.do?keywords='+keywords;
		}
	</script>
