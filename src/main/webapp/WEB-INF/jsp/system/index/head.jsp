...
<div id="navbar" class="navbar navbar-default">
	...
	<div class="navbar-container" id="navbar-container">
		...
		<div class="navbar-header pull-left">
			...
			<a class="navbar-brand"> <small> <i class="fa fa-cogs"></i>
					${pd.SYSNAME}
			</small>
			</a>
				...
				<!-- <li class="grey"><a data-toggle="dropdown"
					...
					<ul
						...
						<li class="dropdown-header"><i class="ace-icon fa fa-check"></i>
							预留功能,待开发</li>
						<li class="dropdown-footer"><a href="javascript:">
								预留功能,待开发 <i class="ace-icon fa fa-arrow-right"></i>
						</a></li>
					</ul></li>
 -->
				<li title="即时聊天" class="purple" onclick="creatw();">
					...
					<ul
						...
						<li class="dropdown-header"><i class="ace-icon fa fa-bell-o"></i>
							  即时通讯</li>
					</ul>
				</li>
				...
				<li class="light-blue"><a data-toggle="dropdown"
					...
					<ul
						...
						<!-- <li><a onclick="editPhoto();" style="cursor: pointer;"><i
								class="ace-icon glyphicon glyphicon-picture"></i>修改头像</a>
						editUserH()在 WebRoot\static\js\myjs\head.js中</li> -->
						<li><a onclick="editUserH();" style="cursor: pointer;"><i
								class="ace-icon fa fa-user"></i>修改资料</a>
						<!-- editUserH()在 WebRoot\static\js\myjs\head.js中 --></li>
						<li id="systemset"><a onclick="editSys();"
							style="cursor: pointer;"><i class="ace-icon fa fa-cog"></i>系统设置</a>
						<!-- editSys()在 WebRoot\static\js\myjs\head.js中 --></li>
						<li><a onclick="editUserMenu();" style="cursor:pointer;"><i class="ace-icon fa fa-cog"></i>自定义菜单</a>
						</li>
						<li class="divider"></li>
