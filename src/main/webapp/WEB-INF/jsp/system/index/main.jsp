...
<body class="no-skin">
					...
					<div class="ace-settings-container" id="ace-settings-container">
						...
						<div class="ace-settings-box clearfix" id="ace-settings-box">
							<div class="pull-left width-50">
								...
								<!-- #section:settings.container -->
								<div class="ace-settings-item">
									<label class="lbl" for="ace-settings-add-container"> <a
										title="关闭所有标签" class="btn btn-mini btn-warning"
										href="main/index">关闭所有标签</a>
									</label>
								</div>
	...
	$(function() {
		...
		var bbb='${bbb}';
		if(bbb=="bbb"){
			//alert("您的密码已经超过一个月没有修改,登录之后请先修改密码");
			/* bootbox.dialog({
				message: "<span class='bigger-110'>您的密码已经超过一个月没有修改,登录之后请先修改密码!</span>",
				buttons: 			
				{
					"button" :
					{
