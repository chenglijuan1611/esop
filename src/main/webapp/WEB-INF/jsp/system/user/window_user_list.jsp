			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<!-- 检索  -->
							<form action="user/listUsersForWindow.do" method="post"
													...
													<c:forEach items="${userList}" var="user" varStatus="vs">
														<tr>
															<td class='center' style="width: 30px;"><label><input
																	type='radio' name="fhadmin" value="${user.USERNAME }"
																	onclick="setUser(this.value)" class="ace" /><span
								...
								<table style="width: 100%;">
									<tr>
										<td style="vertical-align: top;"><a
											class="btn btn-mini btn-primary" onclick="userBinding();">绑定</a>
