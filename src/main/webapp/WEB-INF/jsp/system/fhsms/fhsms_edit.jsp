	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
					...
					<tr>
						<td style="margin-top: 0px;">
							<div style="float: left;" style="width:81%">
								<textarea name="USERNAME" id="USERNAME" rows="1" cols="50"
									style="width: 595px; height: 32px;"
									title="请选输入对方用户名,多个请用(;)分号隔开">${pd.username}</textarea>
							</div>
							<div style="float: right; margin-right: 12px;" style="width:19%">
								<a class='btn btn-mini btn-info' title="查看用户名"
									onclick="dialog_open();"><i
									class="ace-icon fa fa-search nav-search-icon"></i></a>
							</div>
						</td>
					</tr>
					<tr>
						<td style="padding-top: 3px;"><script id="editor"
								type="text/plain" style="width: 643px; height: 259px;"></script>
						</td>
					</tr>
					<tr>
						<td style="text-align: center; padding-top: 15px;" id="nr"><a
							class="btn btn-mini btn-primary" onclick="sendFhsms();">发送</a> <a
							...
							<label style="float: left; padding-left: 32px;"><input
								...
								class="ace" value="icon-edit"><span class="lbl">纯文本</span></label>
							<label style="float: left; padding-left: 5px;"><input
								...
								class="ace"><span class="lbl">带标签</span></label></td>
					</tr>
				</table>
			</div>
			<div id="zhongxin2" class="center" style="display: none">
				...
				<strong id="second_shows" class="red">3秒</strong>后关闭
			</div>
		</div>
		<!-- /.main-content -->
	</div>
