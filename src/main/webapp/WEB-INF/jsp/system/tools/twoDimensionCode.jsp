							...
							<div class="step-content row-fluid position-relative">
								<div style="float: left; margin-top: 5px;">
									<span class="input-icon"> <input type="text"
										id="encoderContent" title="输入内容" value="https://www.baidu.com"
											...
											<div class="widget-body">
												<div class="widget-main">
													<img id="encoderImgId" cache="false"
														src="<%=basePath%>static/images/default.png" width="261px"
														height="261px;" />
												</div>
												<!--/widget-main-->
											</div>
									...
									<div style="width: 399px; float: right;">
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													<div>
														<textarea id="readContent" title="解析结果"
															placeholder="显示解析结果" class="autosize-transition span12"
															style="width: 375px; height: 233px;">
														</textarea>
													</div>
													<div>
