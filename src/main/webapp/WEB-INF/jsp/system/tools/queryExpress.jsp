					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div style="float: left; margin-top: 5px;">
								<span class="input-icon"> <input type="text"
									id="expressNumber" title="请输入快递单号" placeholder="请输入快递单号"
									style="width: 300px;"> <i class="ace-icon fa fa-edit"></i>
								</span>
							</div>
							<div>
								&nbsp; <a class="btn btn-mini btn-success"
									onclick="queryExpress();" style="margin-top: 6px;">查询</a>
							</div>
							<br />
						</div>
						<!-- /.col -->
						<div style="margin-top: 13px; padding-top: 20px;">
							...
							<table class="table table-striped table-bordered table-hover">
								<tr>
									<td>代码中接口类路径：src\com\fh\util\express\GetExpressMsg.java
										(配置APP_KEY和APP_SECRET)</td>
								</tr>
								<tr>
									<td>接口调用需要费用,阿里云充值：<a
										href="https://market.aliyun.com/products/57126001/cmapi011120.html#sku=yuncode512000008"
										target="_back">https://market.aliyun.com/products/57126001/cmapi011120.html#sku=yuncode512000008</a></td>
								</tr>
							</table>
							<div id="zhongxin" class="center" style="display: none;">
								<br />
								<br />
								<br />
								<br />
