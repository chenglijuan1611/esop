...
<body class="gray-bg">
	...
	<div class="main-container" id="main-container">
															...
															<div class="ibox float-e-margins">
																<div class="ibox-content">
																	<div class="alert alert-info">
																		拖拽左侧的表单元素到右侧区域，即可生成相应的HTML代码</div>
																	<form class="form-horizontal m-t">
																		<div class="form-group draggable">
																			<label
																				class="col-sm-3 control-label no-padding-right"
																				for="form-field-1">纯文本：</label>
																			<div class="col-sm-9">
																		...
																		<div class="form-group draggable">
																			<label
																				class="col-sm-3 control-label no-padding-right"
																				for="form-field-1">输入框：</label>
																			<div class="col-sm-9">
																				<input type="text" id="form-field-1"
																					placeholder="提示文字" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		<div class="form-group draggable">
																			<label
																				class="col-sm-3 control-label no-padding-right"
																				for="form-field-1">密码框：</label>
																			<div class="col-sm-9">
																		...
																		<div class="form-group draggable">
																			<label
																				class="col-sm-3 control-label no-padding-right">有图标：</label>
																			<div class="col-sm-9">
																		...
																		<div class="form-group draggable">
																			<label
																				class="col-sm-3 control-label no-padding-right"
																				for="form-field-1">日期框：</label>
																			<div class="col-sm-9">
																				<input class="span10 date-picker" name="name"
																					id="id" value="" type="text"
																					data-date-format="yyyy-mm-dd" readonly="readonly"
																					style="width: 150px;" placeholder="日期" title="日期" />
																			</div>
																		</div>
																		<div class="form-group draggable">
																			<label
																				class="col-sm-3 control-label no-padding-right"
																				for="form-field-1">文件域：</label>
																			<div class="col-sm-9">
																		...
																		<div class="form-group draggable">
																			<label
																				class="col-sm-3 control-label no-padding-right"
																				for="form-field-1">单选框：</label>
																			<div class="col-sm-9">
																				<label
																					style="float: left; padding-left: 8px; padding-top: 7px;">
																					<input name="form-field" type="radio" class="ace"
																					id="form-field-radio1" /> <span class="lbl">单选1</span>
																				</label> <label
																					style="float: left; padding-left: 5px; padding-top: 7px;">
																					<input name="form-field" type="radio" class="ace"
																					id="form-field-radio2" /> <span class="lbl">单选2</span>
																				</label>
																			</div>
																		</div>
																		<div class="form-group draggable">
																			<label
																				class="col-sm-3 control-label no-padding-right"
																				for="form-field-1">复选框：</label>
																			<div class="col-sm-9">
																				<label
																					style="float: left; padding-left: 8px; padding-top: 7px;">
																					<input name="checkbox1" type="checkbox" class="ace"
																					id="checkbox1" /> <span class="lbl">选项1</span>
																				</label> <label
																					style="float: left; padding-left: 5px; padding-top: 7px;">
																					<input name="checkbox2" type="checkbox"
																					class="ace ace-checkbox-2" id="checkbox2" /> <span
																					class="lbl">选项2</span>
																				</label>
																			</div>
																		</div>
																		...
																		<div class="form-group draggable">
																			<label
																				class="col-sm-3 control-label no-padding-right"
																				for="form-field-1">富文本：</label>
																			<div class="col-sm-9">
																				<div class="ueQ313596790Que"></div>
																				<script id="editor" type="text/plain"
																					style="width: 96%; height: 50px;"></script>
																				<div class="ueQ313596790Que"></div>
																			</div>
																		</div>
																		<div class="form-group draggable">
															...
															<div class="ibox float-e-margins">
																...
																<div class="ibox-content">
																	...
																	<button type="submit" class="btn btn-warning"
																		data-clipboard-text="testing" id="copy-to-clipboard">查看代码</button>
																</div>
															</div>
														</div>
													</div>
		...
		<form action="<%=basePath%>/tool/downloadFormCode.do" name="Form"
			id="Form" method="post">
