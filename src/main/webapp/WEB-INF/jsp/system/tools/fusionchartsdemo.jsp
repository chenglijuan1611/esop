								...
								<div class="tabbable">
									<ul class="nav nav-tabs" id="myTab">
										<li class="active"><a data-toggle="tab" href="#home"><i
												class="green icon-home bigger-110"></i>饼状图</a></li>
										<li><a data-toggle="tab" href="#profile"><i
												class="green icon-cog bigger-110"></i>柱状图</a></li>
										<li><a data-toggle="tab" href="#profile3"><i
												class="green icon-cog bigger-110"></i>折线图</a></li>
										<li><a href="http://echarts.baidu.com/examples.html"><i
												class="green icon-cog bigger-110"></i>ECharts</a></li>
									</ul>
									<div class="tab-content">
										...
										<div id="profile" class="tab-pane">
											<table id="table_report"
												...
												<tr>
													<td
														style="width: 76px; text-align: right; padding-top: 13px;">
														<div style="float: left;">
															<table border="0" width="50%">
																<tr>
																	<td><jsp:include
