			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<!-- 检索  -->
							<form action="happuser/listUsers.do" method="post"
								...
								<table id="simple-table"
									...
									<thead>
										<tr>
											...
											<th class="center"><i
												class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>到期日期</th>
													...
													<c:forEach items="${userList}" var="user" varStatus="vs">
														<tr>
															<td class='center' style="width: 30px;"><label><input
																	...
																	id="${user.EMAIL }" alt="${user.PHONE }" class="ace" /><span
																...
																<div class="hidden-sm hidden-xs btn-group">
																	<c:if test="${QX.email == 1 }">
																		<a class="btn btn-xs btn-info" title='发送电子邮件'
																			onclick="sendEmail('${user.EMAIL }');"> <i
																		...
																		<ul
																			...
																			<c:if test="${QX.email == 1 }">
																				<li><a style="cursor: pointer;"
																					...
																					title="发送电子邮件"> <span class="blue"> <i
