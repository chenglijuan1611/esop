							...
							<table id="table_report"
										...
										<div class="starter-template">
											<div id="editor" class="ace_editor ace-monokai ace_dark">
												<textarea id="codeContent" class="ace_text-input" wrap="off"
													...
													style="opacity: 0; height: 17px; width: 8px; left: 45px; top: 0px;"></textarea>
											</div>
										</div>
									</td>
								</tr>
								<tr>
									<td id="sts"><a class="btn btn-mini btn-primary"
										onclick="save();">保存</a> <a class="btn btn-mini btn-success"
										onclick="reduction();">还原</a> <a
										class="btn btn-mini btn-danger" onclick="history();">历史编辑</a>
									</td>
								</tr>
							</table>
						</div>
