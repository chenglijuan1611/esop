				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							...
							<!-- 检索  -->
							<form action="codeeditor/list.do" method="post" name="Form"
								id="Form">
								<input type="hidden" name="TYPE" value="${pd.TYPE }" /> <input
									type="hidden" name="FTLNMAME" value="${pd.FTLNMAME }" />
								<!-- 检索  -->
												...
												<c:forEach items="${varList}" var="var" varStatus="vs">
													<tr>
														<td class='center'><label class="pos-rel"><input
																type='checkbox' name='ids' value="${var.CODEEDITOR_ID}"
																class="ace" /><span class="lbl"></span></label></td>
														<td class='center' style="width: 30px;">${vs.index+1}</td>
														<td class='center'>${var.FTLNMAME}.ftl</td>
														<td class='center'>${var.CTIME}</td>
														<td class="center"><a class="btn btn-xs btn-success"
															title="还原" onclick="reduction('${var.CODEEDITOR_ID}');">
																还原 </a> <a class="btn btn-xs btn-primary" title="查看"
															onclick="view('${var.CODEEDITOR_ID}');"> 查看 </a> <a
															class="btn btn-xs btn-danger"
															onclick="del('${var.CODEEDITOR_ID}');"> <i
