					...
					<div class="commitbox_inner">
						<div class="commitbox_top">
							<textarea name="EMAILs" id="EMAILs"
								placeholder="请输入对方邮箱,多个请用(;)分号隔开" title="请输入对方邮箱,多个请用(;)分号隔开"></textarea>
				...
				<table style="width: 98%; margin-top: 10px; margin-left: 9px;">
						...
						<td style="margin-top: 0px;">
							<div style="float: left;" style="width:81%">
								<textarea name="EMAIL" id="EMAIL" rows="1" cols="50"
									...
									placeholder="请输入对方邮箱,多个请用(;)分号隔开" title="请输入对方邮箱,多个请用(;)分号隔开">${pd.EMAIL}</textarea>
							</div>
					...
					<tr>
						<td><input type="text" name="TITLE" id="TITLE" value=""
							placeholder="请输入邮件标题" style="width: 99%" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td style="text-align: center; padding-top: 15px;" id="nr"><a
							class="btn btn-mini btn-primary" onclick="sendEm();">发送</a> <a
							...
							style="float: left; padding-left: 15px;"><input
								name="form-field-checkbox" class="ace" type="checkbox"
								id="allusers" onclick="isAll();" /><span class="lbl">全体用户</span></label>
						</td>
					</tr>
				</table>
			</div>
