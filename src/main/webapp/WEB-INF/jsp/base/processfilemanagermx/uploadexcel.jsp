		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<form action="processfilemanagermx/readExcel.do?material=${pd.material}&mxId=${pd.mxId}" name="Form" id="Form"
								method="post" enctype="multipart/form-data">
								<div id="zhongxin">
									<table style="width: 95%;">
										<tr>
											<td style="padding-top: 20px;"><input type="file"
												id="excel" name="excel" style="width: 50px;"
										...
										<tr>
											...
											<a class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/model/downExcel.do'">下载模版</a>
											</td>
										</tr>
									</table>
								</div>
