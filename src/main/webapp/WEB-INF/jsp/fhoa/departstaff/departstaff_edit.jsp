								...
								<div id="zhongxin" style="padding-top: 13px;">
									...
									<table id="table_report"
										...
										<tr>
											...
											<td><input type="text" name="STAFF_NAME" id="STAFF_NAME"
												value="${pd.STAFF_NAME}" maxlength="50" placeholder="这里输入姓名"
												title="姓名" style="width: 98%;" /></td>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">性别:</td>
											<td><select name="STAFF_SEX" id="STAFF_SEX"
												style="width: 98%;">
													<option <c:if test="${pd.STAFF_SEX == '男'}">selected</c:if>>男</option>
													<option <c:if test="${pd.STAFF_SEX == '女'}">selected</c:if>>女</option>
											</select></td>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">出生日期:</td>
											<td><input class="span10 date-picker"
												name="STAFF_BIRTHDAY" id="STAFF_BIRTHDAY"
												value="${pd.STAFF_BIRTHDAY}" type="text"
										...
										<tr>
											...
											<td><input type="text" name="STAFF_NAME_EN"
												...
												maxlength="50" placeholder="这里输入英文" title="英文"
												style="width: 98%;" /></td>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">婚否:</td>
											<td><select name="STAFF_MARITAL" id="STAFF_MARITAL"
												style="width: 98%;">
													<option
														<c:if test="${pd.STAFF_MARITAL == '未婚'}">selected</c:if>>未婚</option>
													<option
														<c:if test="${pd.STAFF_MARITAL == '已婚'}">selected</c:if>>已婚</option>
											</select></td>
											<td
										...
										<tr>
											...
											<td><input type="text" name="STAFF_BIANMA"
												...
												placeholder="这里输入编码" title="编码" style="width: 98%;" /></td>
											<td
											...
											<td><input class="span10 date-picker"
												name="STAFF_PJOINTIME" id="STAFF_PJOINTIME"
												value="${pd.STAFF_PJOINTIME}" type="text"
												data-date-format="yyyy-mm-dd" readonly="readonly"
										...
										<tr>
											...
											<td colspan="10"><input type="text" name="STAFF_SFID"
												id="STAFF_SFID" value="${pd.STAFF_SFID}" maxlength="20"
									...
									<table id="table_report"
										...
										<tr>
											...
											<td><input type="text" name="STAFF_POST" id="STAFF_POST"
												value="${pd.STAFF_POST}" maxlength="30"
												placeholder="这里输入现岗位" title="现岗位" style="width: 98%;" /></td>
											<td
											...
											<td><input type="text" name="STAFF_JOBTYPE"
												...
												maxlength="30" placeholder="这里输入岗位类别" title="岗位类别"
												style="width: 98%;" /></td>
										</tr>
										<tr>
											<td
											...
											<td colspan="10"><input type="text"
												name="STAFF_FUNCTIONS" id="STAFF_FUNCTIONS"
												value="${pd.STAFF_FUNCTIONS}" maxlength="255"
										...
										<tr>
											...
											<td><input class="span10 date-picker"
												name="STAFF_JOBJOINTIME" id="STAFF_JOBJOINTIME"
												value="${pd.STAFF_JOBJOINTIME}" type="text"
												data-date-format="yyyy-mm-dd" readonly="readonly"
												placeholder="首次参加工作时间" title="参加工作时间" style="width: 98%;" /></td>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">入职时间:</td>
											<td><input class="span10 date-picker"
												name="STAFF_DJOINTIME" id="STAFF_DJOINTIME"
												value="${pd.STAFF_DJOINTIME}" type="text"
												data-date-format="yyyy-mm-dd" readonly="readonly"
												placeholder="进本单位时间" title="进本单位时间" style="width: 98%;" /></td>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">上岗时间:</td>
											<td><input class="span10 date-picker"
												name="STAFF_POJOINTIME" id="STAFF_POJOINTIME"
												value="${pd.STAFF_POJOINTIME}" type="text"
												data-date-format="yyyy-mm-dd" readonly="readonly"
									...
									<table id="table_report"
										...
										<tr>
											...
											<td><input type="text" name="STAFF_EMAIL"
												...
												placeholder="这里输入邮箱" title="邮箱" style="width: 98%;" /></td>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">电话:</td>
											<td colspan="10"><input type="text" name="STAFF_TEL"
												id="STAFF_TEL" value="${pd.STAFF_TEL}" maxlength="20"
												placeholder="这里输入电话" title="电话" style="width: 98%;" /></td>
										</tr>
										<tr>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">籍贯:</td>
											<td colspan="10"><input type="text"
												name="STAFF_FADDRESS" id="STAFF_FADDRESS"
												value="${pd.STAFF_FADDRESS}" maxlength="100"
												placeholder="这里输入籍贯" title="籍贯" style="width: 98%;" /></td>
										</tr>
										<tr>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">现住址:</td>
											<td colspan="10"><input type="text" name="STAFF_ADDRESS"
										...
										<tr>
											...
											<td><input type="text" name="STAFF_EDUCATION"
												...
												maxlength="10" placeholder="这里输入学历" title="学历"
												style="width: 98%;" /></td>
											<td
										...
										<tr>
											...
											<td><input type="text" name="STAFF_FTITLE"
												...
												placeholder="这里输入职称" title="职称" style="width: 98%;" /></td>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">资格证书:</td>
											<td colspan="10"><input type="text"
												name="STAFF_CERTIFICATE" id="STAFF_CERTIFICATE"
												value="${pd.STAFF_CERTIFICATE}" maxlength="30"
										...
										<tr>
											...
											<td><input class="span10 date-picker"
												name="STAFF_CSTARTTIME" id="STAFF_CSTARTTIME"
												value="${pd.STAFF_CSTARTTIME}" type="text"
												data-date-format="yyyy-mm-dd" readonly="readonly"
												placeholder="签订日期" title="签订日期" style="width: 98%;" /></td>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">终止日期:</td>
											<td><input class="span10 date-picker"
												name="STAFF_CENDTIME" id="STAFF_CENDTIME"
												value="${pd.STAFF_CENDTIME}" type="text"
												data-date-format="yyyy-mm-dd" readonly="readonly"
									...
									<table id="table_report"
										...
										<tr>
											...
											<td><input type="text" name="STAFF_BZ" id="STAFF_BZ"
												value="${pd.STAFF_BZ}" maxlength="255" placeholder="这里输入备注"
