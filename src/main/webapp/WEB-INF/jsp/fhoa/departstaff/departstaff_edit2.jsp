								...
								<div id="zhongxin" style="padding-top: 13px;">
									<table id="table_report"
										...
										<tr>
											...
											<td><input type="text" class="span10 date-picker"
												name="DEPART_STARTTIME" id="DEPART_STARTTIME"
												value="${pd.DEPART_STARTTIME}" data-date-format="yyyy-mm-dd"
												readonly="readonly" maxlength="255" placeholder="这里输入成立日期"
												title="成立日期" style="width: 98%;" /></td>
										</tr>
										<tr>
