							...
							<table style="width: 100%; height: 100%;" border="0">
								<tr>
									...
									<td style="width: 85%;" valign="top">
										<!-- 检索  -->
										<form action="staff/list.do" method="post" name="Form"
											id="Form">
											<input name="ZDEPARTMENT_ID" id="ZDEPARTMENT_ID"
													...
													<tr>
														<th class="center" style="width: 35px;"><label
															class="pos-rel"><input type="checkbox"
																class="ace" id="zcheckbox" /><span class="lbl"></span></label></th>
																...
																<c:forEach items="${varList}" var="var" varStatus="vs">
																	<tr>
																		<td class='center'><label class="pos-rel"><input
																				type='checkbox' name='ids' value="${var.STAFF_ID}"
																		...
																		<td class="center"><c:if
																			...
																			<div class="hidden-sm hidden-xs btn-group">
																				...
																				<c:if test="${QX.Datajur == 1 }">
																					<a class="btn btn-warning btn-xs" title="授权"
