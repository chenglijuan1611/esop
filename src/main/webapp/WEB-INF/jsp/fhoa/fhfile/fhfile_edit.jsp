				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="fhfile/${msg }.do" name="Form" id="Form"
								method="post">
								...
								<div id="zhongxin" style="padding-top: 13px;">
									<table id="table_report"
										...
										<tr>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">文件名:</td>
											<td><input type="text" name="NAME" id="NAME" value=""
												maxlength="30" placeholder="这里输入文件名" title="文件名"
												style="width: 98%;" /></td>
										</tr>
										<tr>
											<td
											...
											<td><input type="file" name="File_name" id="uploadify1"
												...
												name="FILEPATH" id="FILEPATH" value="" /></td>
										</tr>
										<tr>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">备注:</td>
											<td><input type="text" name="BZ" id="BZ" value=""
