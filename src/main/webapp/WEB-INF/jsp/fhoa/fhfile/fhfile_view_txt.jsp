...
<body class="no-skin">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<table id="table_report"
								...
								<tr>
									<td id="sts"><a class="btn btn-mini btn-primary"
										onclick="zencoding('utf-8');">UTF-8</a> <a
										class="btn btn-mini btn-success" onclick="zencoding('gbk');">GBK</a>
										<a class="btn btn-mini btn-info"
										onclick="zencoding('gb2312');">GB2312</a> <a
										class="btn btn-mini btn-danger"
										onclick="zencoding('gb18030');">GB18030</a> <a
										class="btn btn-mini btn-warning" onclick="zencoding('big5');">BIG5</a>
									</td>
								</tr>
								<tr>
									<td colspan="10">
										<div class="starter-template">
											<div id="editor" class="ace_editor ace-monokai ace_dark">
												<textarea id="codeContent" class="ace_text-input" wrap="off"
	...
	<script src="plugins/codeEditor/ace.js" type="text/javascript"
