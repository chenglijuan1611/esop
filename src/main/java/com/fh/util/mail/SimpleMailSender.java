...
/**   
  ...
  */    
    ...
    public static void main(String[] args){   
        //这个类主要是设置邮件   
	     MailSenderInfo mailInfo = new MailSenderInfo();    
	     mailInfo.setMailServerHost("smtp.outlook.com");    
	     mailInfo.setMailServerPort("587");    
	     mailInfo.setValidate(true);    
	     mailInfo.setUserName("zxzhaoll@outlook.com");    
	     mailInfo.setPassword("zhaolili0313");//您的邮箱密码    
	     //mailInfo.setPassword("zjiqnotsvqfpdhfb");//您的邮箱密码    
	     mailInfo.setFromAddress("zxzhaoll@outlook.com");    
	     mailInfo.setToAddress("2917453913@qq.com");    
