...
public class DESUtil {
    ...
    public static void main(String[] args) {
    	String url = "jdbc:sqlserver://172.16.90.10:1433;databaseName=UFDATA_003_2019";
    	String name = "mesuser";
    	String password = "rILt3YTZGPUFEyI$";
    	String encryurl = getEncryptString(url);
    	String encryname = getEncryptString(name);
    	String encrypassword = getEncryptString(password);
    	System.out.println("encryurl : " + encryurl);
    	System.out.println("encryname : " + encryname);
    	System.out.println("encrypassword : " + encrypassword);
    	System.out.println("url : " + getDecryptString(encryurl));
