...
public class Const {
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(webservice)|(helloWorld)|(logout)|(code)|(plan2)|(equipmentrun2)|(plan3)|(android)|(bugquery1)|(productinspection1)|(bug1)|(equipmentFile1)|(inspectiontickt1)|(inspectionrecord1)|(inspectionrecorditem)|(app)|(weixin)|(static)|(main)|(websocket)|(uploadImgs)).*";	//不对匹配该值的访问路径拦截（正则）
