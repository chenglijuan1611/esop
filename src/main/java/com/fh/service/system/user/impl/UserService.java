...
public class UserService implements UserManager{
	 ...
	 * @throws Exception
	 */
	public void updateLastUpdatePW(PageData pd)throws Exception{
		dao.update("UserMapper.updateLastUpdatePW", pd);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<User> listByDepartmentId(String DEPARTMENT_ID)throws Exception{
		return  (List<User>) dao.findForList("UserMapper.listByDepartmentId", DEPARTMENT_ID);
	}
